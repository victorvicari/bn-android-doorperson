...
import com.bigneon.studio.controller.TicketDataHandler.Companion.addRefreshTicketsListener
import com.bigneon.studio.controller.TicketDataHandler.Companion.removeRefreshTicketsListener
import com.bigneon.studio.controller.TicketDataHandler.Companion.storeTickets
        ...
        object : NetworkStateReceiver.NetworkStateReceiverListener {
            override fun networkAvailable() {
                ...
                if (!isLoadingInProgress() && !isBackPressed) {
                    loading_text.text = getString(com.bigneon.studio.R.string.loading_tickets_is_about_to_begin)
            ...
            override fun networkUnavailable() {
                ...
                loading_text.text = getString(com.bigneon.studio.R.string.loading_tickets_waiting_for_network)
                loading_progress_bar.isIndeterminate = true
            }
        }
...
//                            isLoadingInProgress = true
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.bigneon.studio.R.layout.activity_scanning_event)
    ...
    private fun getEventSummary() {
        ...
        if (event != null && redeemedTicketNumberForEvent != null && allTicketNumberForEvent != null) {
            ...
            number_of_redeemed.text = getString(
                com.bigneon.studio.R.string._1_d_of_2_d_redeemed,
                redeemedTicketNumberForEvent,
                allTicketNumberForEvent
            )
            number_of_checked.text = getString(
                com.bigneon.studio.R.string._1_d_checked,
