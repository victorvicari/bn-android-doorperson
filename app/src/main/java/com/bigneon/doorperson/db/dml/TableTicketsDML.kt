...
object TableTicketsDML {
    ...
    const val TABLE_TICKETS_CREATE =
        ("create table $TABLE_TICKETS($TICKET_ID text not null, $EVENT_ID text not null, $USER_ID text null, $PRICE_IN_CENTS integer not null, $TICKET_TYPE_NAME text not null, $REDEEM_KEY text not null, $STATUS text not null);")
